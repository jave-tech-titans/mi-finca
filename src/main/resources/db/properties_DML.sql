...
BEGIN
    ...
    INSERT INTO payments(
        id, account_number, bank, value ,schedule_id ,created_at, status
    )VALUES
        (gen_random_uuid(), 1165454, 'Bancolombia', 14220,sch_1, NOW(), 0),
        (gen_random_uuid(), 2500303, 'Davivienda', 471100,sch_2, NOW(), 0);
